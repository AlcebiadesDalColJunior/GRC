...
#t_gravity_centrality_current = list(np.load("results/sensor_GC.npy"))
#t_EffG_current = list(np.load("results/sensor_EffG.npy"))
...
for i in range(n_iter):
    ...
    G = nx.random_geometric_graph(n, kappa)
...
plt.savefig('results/sensor_time.pdf', bbox_inches='tight')
plt.show()
...
#np.save("results/sensor_GC",np.array(t_gravity_centrality_current))
#np.save("results/sensor_EffG",np.array(t_EffG_current))
