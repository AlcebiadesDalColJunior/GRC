...
signal[nodes.index(45)] = 20
signal[nodes.index(33)] = 20
...
plt.savefig('results/Taipei_signal.pdf', bbox_inches='tight')
#plt.savefig('results/Taipei_signal.eps', bbox_inches='tight')
plt.show()

plt.figure()
nx.draw_networkx(G, pos, with_labels=False, node_size=50, vmin=vmin, vmax=vmax,
                  node_color=list(I_grc_signal.values()), cmap=cmap)
plt.savefig('results/Taipei_smooth_signal.pdf', bbox_inches='tight')
#plt.savefig('results/Taipei_smooth_signal.eps', bbox_inches='tight')
plt.show()
