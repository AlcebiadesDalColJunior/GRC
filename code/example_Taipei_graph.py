...
plt.figure()
nx.draw_networkx(G, pos=pos, node_color="lightblue", node_size=30, font_size=3.6)
# nx.draw_networkx(G, pos=pos, node_color="lightblue", node_size=80, font_size=6)
plt.savefig('results/Taipei.pdf', bbox_inches='tight')
#plt.savefig('results/Taipei.eps', bbox_inches='tight')
plt.show()
...
for i in range(n_names):
    ...
    plt.savefig('results/Taipei_'+names[i]+'.pdf', bbox_inches='tight')
    #plt.savefig('results/Taipei_'+names[i]+'.eps', bbox_inches='tight')
    plt.show()
    ...
    print("Greater centralities of",names[i])
    for j in range(-2,0):
    ...
    plt.savefig('results/Taipei_'+names[i]+'_signature.pdf', bbox_inches='tight')
    #plt.savefig('results/Taipei_'+names[i]+'_signature.eps', bbox_inches='tight')
    plt.show()
