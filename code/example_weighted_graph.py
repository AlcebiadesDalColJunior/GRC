...
edges = [(0,4,6),(0,5,4),(1,3,4),(1,7,2),(2,4,5),(2,7,6),(3,9,6),(4,9,4),
         (5,6,4),(5,9,6),(7,8,3)]
...
plt.savefig('results/weighted_graph.pdf', bbox_inches='tight')
#plt.savefig('results/weighted_graph.eps', bbox_inches='tight')
plt.show()
...
for i in range(n_names):
    ...
    plt.savefig('results/weighted_graph_'+names[i]+'.pdf', bbox_inches='tight')
    #plt.savefig('results/weighted_graph_'+names[i]+'.eps', bbox_inches='tight')
    plt.show()
    ...
    plt.savefig('results/weighted_graph_'+names[i]+'_signature.pdf', bbox_inches='tight')
    #plt.savefig('results/weighted_graph_'+names[i]+'_signature.eps', bbox_inches='tight')
    plt.show()
