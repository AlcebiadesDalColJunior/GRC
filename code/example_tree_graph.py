...
plt.savefig('results/tree.pdf', bbox_inches='tight')
#plt.savefig('results/tree.eps', bbox_inches='tight')
plt.show()
...
for i in range(2):
    ...
    plt.savefig('results/tree_'+names[i]+'.pdf', bbox_inches='tight')
    #plt.savefig('results/tree_'+names[i]+'.eps', bbox_inches='tight')
    plt.show()
    ...
    plt.savefig('results/tree_'+names[i]+'_signature.pdf', bbox_inches='tight')
    #plt.savefig('results/tree_'+names[i]+'_signature.eps', bbox_inches='tight')
    plt.show()
